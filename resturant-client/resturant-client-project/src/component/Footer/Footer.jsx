import logo from '../../assets/whyChoose/logo.png' 
...
<footer className="footer p-10 mt-6 bg-green-200 text-base-content">
  <aside>
    <img className='w-20 h-20 rounded-sm' src={logo} alt="" />
    <p className="font-semibold text-xl">DineEase Ltd.<br/>Providing reliable food since 1992</p>
  </aside> 
  <nav>
