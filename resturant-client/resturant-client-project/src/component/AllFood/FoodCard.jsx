...
const SpotCard = ({ food, setFood }) => {
    const  { _id, foodname, category, image, quantity, price, origin, description,email } = food;

    return (
        <div className="card card-compact border-2  rounded-sm  bg-[#e9e9e9f3] shadow-xl p-1">
        <div className="flex flex-col gap-3">
            ...
            <h4 className="pb-1 text-lg text-[#1b652b] font-medium ">#{category}</h4>
            
            
            <div className="flex text-lg justify-start">
                        <h3 className='text-[#195430] font-medium'><span className='text-red-500'>Price:</span> ${price}</h3>
            </div>
